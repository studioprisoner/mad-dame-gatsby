        ...
        <div className="lg:relative bg:white">
            <div className="lg:absolute lg:inset-0">
                <div className="lg:absolute lg:inset-y-0 lg:left-0 lg:w-1/2">
                    <img src={MadDameImage} alt="Mad Dame" className="object-contain w-full h-56 lg:object-cover lg:absolute lg:h-full"/>
                </div>
            </div>
            <div className="relative px-4 pt-12 pb-16 sm:pt-16 sm:px-6 lg:px-8 lg:max-w-7xl lg:mx-auto lg:grid lg:grid-cols-2">
                <div className="lg:col-start-2 lg:pl-8">
                    <div className="mx-auto text-base max-w-prose lg:max-w-lg lg:ml-auto lg:mr-0">
                        <h2 className="font-semibold leading-6 tracking-wide text-blue-900 uppercas">About Mad Dame</h2>
